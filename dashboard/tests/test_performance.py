...
class DashboardPerformanceTestCase(TestCase):
    ...
    def test_overview_api_performance(self):
        """
        Test performance of overview API
        """
    ...
    def test_application_dashboard_performance(self):
        """
        Test performance of application dashboard API
        """
    ...
    def test_entity_dashboard_performance(self):
        """
        Test performance of entity dashboard API
        """
    ...
    def test_cache_invalidation(self):
        ...
        cache_key = get_cache_key('overview', {'days': 30})
        ...
        # Make another request (should be uncached)
        response2 = self.client.get(url)
        self.assertEqual(response2.status_code, 200)
