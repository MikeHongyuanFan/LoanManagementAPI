...
SECRET_KEY = 'django-insecure-5x6s6=4*xn_ulc)x(gl+8ycex1@a%t)d6g$^6avs2s+#%-ad&4'
...
# Haystack settings for full-text search
...
LOGGING = {
    ...
    'handlers': {
        ...
        'performance_file': {
            'level': 'INFO',
            'class': 'logging.FileHandler',
            'filename': os.path.join(BASE_DIR, 'logs', 'dashboard_performance.log'),
